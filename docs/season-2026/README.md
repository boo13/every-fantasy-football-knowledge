...
Season-specific material is dated evidence, not permanent truth. Recheck source dates and official availability before applying it to a decision.
...
This is not a comprehensive injury list, a proprietary ranking mirror, or a set of projected depth charts. Use [the handbook](../handbook/README.md) for decision methods and [the evidence query tool](../querying-data.md) for focused records.
