# Durable learning index

Reusable, evidence-backed lessons maintained with Compound Engineering. Read relevant lessons before changing the collector or interpreting its data. Generic football heuristics live in [the decision framework](../decision-framework.md); these entries document a specific established learning.

| Lesson | Area | Evidence |
| --- | --- | --- |
