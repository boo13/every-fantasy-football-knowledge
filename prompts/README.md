...
> Summarize material changes since the previous observation. Distinguish confirmed public news from provider-field changes and speculative role changes. Identify waiver research leads, upcoming schedule concerns, and questions requiring live checks. Do not assume any player is available or recommend a transaction without my private settings.

## Start/sit

> Compare the options I supply privately for this scoring format and week. Check current official availability, projected role, and kickoff times. Cite the evidence, give a conditional recommendation and alternative, and name the news that would change your answer. Do not report unsupported numerical win probabilities.
